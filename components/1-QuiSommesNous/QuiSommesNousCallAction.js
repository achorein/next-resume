...
class QuiSommesNousCallAction extends PureComponent {
  render() {
    return (
      <div>
        {/*= ===================  feature icon area ==================== */}
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                      <div className="single-feature-icon text-center">
                        ...
                        <a href="/contact" className="ht-btn ht-btn--round">
                          NOUS CONTACTER
                        </a>
                      </div>
                    </div>
        ...
        <div className="feature-icon-area section-space--inner--special-2" />
      </div>
    );
  }
}

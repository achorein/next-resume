                      ...
                      <form id="contact-form">
                          <div className="row row-10">
                              ...
                              <div className="col-md-6 col-12 section-space--bottom--20">
                                  ...
                                  <div className="prenom_error"></div>
                              ...
                              <div className="col-12">
                                  <Field name="message" component="textarea" placeholder="Votre message" rows="2" className="form-control" />
                                  <div className="message_error"></div>
                                   <ErrorMessage name="message" component="div" className="message_error" />

                              </div>
                              <div className="col-12"><button>ENVOYER</button></div>
                          </div>
                      </form>

...
class BackendService {
  ...
  prospect() {
    return axios.post(`${API_URL}prospect`, { headers: { 'Content-Type': 'application/json; charset=UTF-8' } });
  }

  findServicesAll() {
    return axios.get(`${API_URL}services/all`, { headers: { 'Content-Type': 'application/json; charset=UTF-8' } });
  }
